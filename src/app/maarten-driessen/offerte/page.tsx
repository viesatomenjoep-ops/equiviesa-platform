...
export default function OfferteHubPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      link: "/maarten-driessen/generator",
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-amber-900 pb-20">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-12 px-6 bg-amber-600 text-white rounded-b-[3rem]">
        <div className="max-w-4xl mx-auto text-center mt-8">
          ...
          <p className="text-xl text-slate-300 mb-8 font-light">
            Maarten Driessen is het grootste platform van Nederland. Kies hieronder de slimme AI tool die u nodig heeft en ontvang direct antwoord.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-12 -mt-10 relative z-10">
        <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="max-w-2xl mx-auto bg-gray-50 border-2 border-dashed border-slate-300 rounded-3xl p-10 hover:border-slate-900 transition-colors">
              {!isUploading && !uploadResult ? (
                ...
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="text-xl font-bold text-amber-900 mb-6 text-center">{uploadResult}</h3>
                  <div className="flex gap-4">
                    <Link href="/maarten-driessen/calculator" className="px-6 py-3 bg-amber-600 text-white rounded-full font-bold hover:bg-amber-700 transition-colors">
                      Accepteren & Plannen
                    </Link>
                    <button onClick={() => setUploadResult(null)} className="px-6 py-3 border border-gray-300 text-amber-900 rounded-full hover:bg-gray-100 font-bold transition-colors">
                      Nieuwe Foto
                    </button>
                  </div>
                </div>
          ...
          {/* AI Calculators Grid */}
          <div>
            <h2 className="text-2xl font-bold text-amber-900 mb-8 px-2">Andere AI Offerte Calculators</h2>
                ...
                <Link href={tool.link} key={idx}>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-amber-900 mb-2 group-hover:text-slate-700 transition-colors">
                        {tool.title}
                      </h3>
                      <p className="text-slate-600 mb-4 leading-relaxed">
                        {tool.description}
                      </p>
                      <div className="flex items-center text-sm font-bold text-amber-900">
