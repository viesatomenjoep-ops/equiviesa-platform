  ...
  if (submitted) {
    return (
      <div className="bg-gray-50 min-h-screen pt-32 pb-20 flex flex-col items-center px-4">
        ...
        <p className="text-gray-500 text-center max-w-md">Thank you. Your second opinion report has been securely uploaded to Viesa Automations Portfolio Management.</p>
      </div>
    )
  }
          ...
          <div className="grid md:grid-cols-2 p-8 gap-12">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-6 leading-relaxed">
                By downloading these files, you agree to maintain strict confidentiality. These documents are the intellectual property of Viesa Automations.
              </p>
            </div>
