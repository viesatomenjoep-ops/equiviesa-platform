...
import { Stethoscope, Calendar, Plus, Syringe, Activity, AlertCircle, Phone } from 'lucide-react'
...
export default function HealthBoard({ horses, initialLogs, contacts }: any) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
      ...
      <div className="p-0">
        {logs.length === 0 ? (
          <div className="p-8 text-center text-gray-500">Nog geen medische gegevens geregistreerd.</div>
        ) : (
